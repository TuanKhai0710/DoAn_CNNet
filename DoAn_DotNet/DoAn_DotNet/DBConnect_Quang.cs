...
namespace DoAn_DotNet
{
    class DBConnect_Quang
    {
        ...
        public string chuoiketnoi = @"Data Source=VUONG-TRAN\MSSQLSERVER01;Initial Catalog=QUAN_LY_CUA_HANG_BAN_DIEN_THOAI;Persist Security Info=True;User ID=sa;Password=123";
        SqlConnection conn;

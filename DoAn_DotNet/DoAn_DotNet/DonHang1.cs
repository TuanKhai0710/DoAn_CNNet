...
{
    public partial class DonHang1 : Form
    {
        DataTable dt;
        ...
        public DonHang1()
        {
            conStr = new SqlConnection(@"Data Source=VO-NHUT-HAO\SQLEXPRESS;Initial Catalog=QUAN_LY_CUA_HANG_BAN_DIEN_THOAI;Persist Security Info=True;User ID=sa;Password=123");
